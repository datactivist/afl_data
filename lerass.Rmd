...
.pull-left[
.red[Sources et méthodologie]

- Recherche documentaire (articles de presse, documents)
- Observations issues d'activités associatives et professionnelles

.red[Principaux points]

- Outils internationaux de suivi
- Dispositifs de surveillance de la pandémie en France
- Initiatives citoyennes de collecte et de visualisation des données
- Relance de la politique d'open data en France
- Emergence de médiateurs
- Liens entre société civile et administrations ?
